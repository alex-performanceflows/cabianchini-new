...
export const apartments: Apartment[] = [
  {
    ...
    images: Array.from({ length: 13 }, (_, i) => `/images/villa-anna/Villa-Anna_Slider-${i + 1}.webp`),
  ...
  },
  {
    ...
    coverImage: "/images/appartamenti/villa-bina/Villa-Bina_Slider-1.webp",
    ...
    images: Array.from({ length: 8 }, (_, i) => `/images/appartamenti/villa-bina/Villa-Bina_Slider-${i + 1}.webp`),
    petsAllowed: false,
  },
  {
    id: "villa-coco",
  ...
  },
  {
    ...
    images: Array.from({ length: 11 }, (_, i) => `/images/villa-arzilla/Villa-Arzilla_Slider-${i + 1}.webp`),
