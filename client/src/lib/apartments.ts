...
export const apartments: Apartment[] = [
  ...
  },
  {
    ...
    images: Array.from({ length: 4 }, (_, i) => `/images/villa-arzilla/Villa-Arzilla_Slider-${i + 1}.webp`),
    petsAllowed: true,
    disabledAccess: true,
  },
  {
